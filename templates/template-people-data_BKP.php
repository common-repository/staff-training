                                        ...
                                        <?php
                                           foreach($value as $sid => $sval) {                        
                                                ...
                                                $results = $wpdb->get_results(
                                                    $wpdb->prepare(
                                                        "SELECT * FROM {$wpdb->prefix}quiz_details as qt INNER JOIN {$wpdb->prefix}quiz_user_details as qut ON qt.quizid = qut.quizid WHERE qt.sectionid = %d AND qut.userid = %d",
                                                        $sid,
                                                        $user_id
                                                    ),
                                                    ARRAY_A
